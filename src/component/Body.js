          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 cursor-pointer ">
            {[
              ...
              <div
                key={skill}
                className="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900
                 p-6 rounded-lg shadow-lg hover:shadow-xl  transition duration-300 ease-in-out hover:scale-95 hover:bg-transparent-100 text-gray-700 cursor-pointer"
              >
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-semibold text-gray-300">{skill}</h3>
              </div>
            ))}
          </div>
          <div className="mt-8">
