        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {filters.map((filter) => (
            <button
              ...
              className={`px-6 py-3 rounded-lg font-medium  transition duration-300 ease-in-out hover:scale-95 hover:bg-transparent-100 cursor-pointer ${
          ...
          {filteredProjects.map((project) => (
            <div key={project.id} className="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900
              ...
              <div className="p-6">
                ...
                {/* Features */}
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-300 mb-2 text-sm">Key Features:</h4>
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 text-center border border-gray-300 text-gray-300 py-2 rounded-lg hover:border-gray-400 transition-colors text-sm font-medium"
                  >
                    Source Code
                  </a>
                </div>
